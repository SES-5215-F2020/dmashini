...
In my three correlation analysis I see a weak, but statistically significant, positive relationship at a 95% confidence level. The stronger correlation is seen between age and income (p-value =0.24).
...
I can assume there is a statistically significant relationship at a 95% confidence interval between educational attainment and means of transportation because in the chi-square test the p-value is below 0.05. 
I see some values that are particularly low, such as no schooling completed with non-motorized mobilization and doctorate with bus, streetcar or subway.
...
There exists a significant association between educational attainment and age, income and travel time. In a more in depth review of income and educational attainment, there appears a positive difference and significant association, except between Highschool diploma and No schooling completed (p adj = 0.085).
...
There exists a significant relationship between means of transportation and all the continuous variables at a 95% confidence level, with all p-values are under the 0.05 threshold.
In the difference check between income and means of transportation, there is a less incidence of income between the variables 'bus, streetcar or subway' and 'bicycle or walked'.
...
To further my analysis, I combined the categorical variable of means of transportation in motorized and non-motorized, to test them with Age through a two-sample t-test. 
...
There is a significant relationship (negative, seen in the 95 percent confidence interval) found between age and means of transportation (motorized and non-motorized); younger people use more non-motorized transportation.
