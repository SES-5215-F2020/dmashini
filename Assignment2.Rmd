...
I will display the information in a summary table:
...
ggplot(data, aes(x = Income)) + 
  geom_histogram(color = "gray", binwidth = 80) +
  theme_bw() +
...
The income distribution is also positively skewed, with the main values concentrated between USD 20,000 and 70,000.There are some high-value outliers that extend the tail of the graph and affect the mean of the variable. 
...
```{r}
datatable_2 <- tibble(`Educational Attainment`= c("01", "16", "19", "21", "22", "24"),
